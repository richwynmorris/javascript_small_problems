...
function findDup (array) {
  for(let outerIx = 0; outerIx < array.length; outerIx++) {
    for(let innerIx = outerIx + 1; innerIx < array.length; innerIx++) {
      if (array[outerIx] === array[innerIx]) {
        return array[innerIx];
      }
    }
  }
}
