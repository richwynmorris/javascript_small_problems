...
// The function should return an array containing the same number of elements as the 
...
function sequence(maxMultiplyier, num) {
  let result = []
  for (let multiplyier = 1; multiplyier <= maxMultiplyier; multiplyier++) {
    result.push(multiplyier * num)
  }
  return result
}
